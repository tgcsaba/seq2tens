...
from models import init_resnet_model
...
#             K.set_session(sess)
        ...
        model = init_resnet_baseline(input_shape, num_classes)

        train_baseline(dataset, model, normalize_data=True, batch_size=16, epochs=1500, opt=keras.optimizers.Adam(), save_dir=save_dir, experiment_idx=i)