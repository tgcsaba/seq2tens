...
def init_lrs3_model(input_shape, num_levels, num_hidden, num_classes, recursive_tensors=True, reverse=False, use_batchnorm=True, order=1):
    ...
    model.name = 'LRS3BN_M{}_H{}_D{}'.format(num_levels, num_hidden, order) if use_batchnorm else 'LRS3_M{}_H{}_D{}'.format(num_levels, num_hidden, order) 
